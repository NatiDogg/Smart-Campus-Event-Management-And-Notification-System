...
import { createNewOrganizer } from "../repositories/organizerRepository.js";
...
class AdminService{
       async createOrganizer(organizerData:organizerCreationType){
           ...
           const newlyCreatedOrganizer = await createNewOrganizer({...organizerData, email: normalizedEmail, password: hashedPassword});
