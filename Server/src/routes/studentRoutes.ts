...
import { getAllStudentEventsHandler, getStudentCalendarHandler,getStudentAiRecommendations } from '../controllers/studentController.js'
...
studentRouter.get('/recommendations', getStudentAiRecommendations as unknown as RequestHandler);
