...
const Login = () => {
  return (
    ...
    <div className="w-full hidden lg:block">
        <img className="h-full object-cover" width={1000} src={landingImg} alt="dev connect image" />
    </div>
    ...
    <div className="w-full flex flex-col items-center justify-center">
        ...
        <form className="md:w-96 w-80 flex flex-col items-center justify-center">
            ...
            <p className="text-sm text-gray-500/90 mt-3">Welcome back! Please log in to continue</p>

            <button type="button" className="w-full mt-8 bg-gray-500/10 flex items-center text-gray-600 cursor-pointer hover:bg-gray-200 gap-2 justify-center h-12 rounded-full">
                <FcGoogle /> <span>Login with Google</span>
            </button>

            <div className="flex items-center gap-4 w-full my-5">
                <div className="w-full h-px bg-gray-300/90"></div>
                <p className="w-full text-nowrap text-sm text-gray-500/90">or log in with email</p>
                <div className="w-full h-px bg-gray-300/90"></div>
            </div>
            ...
            <button type="submit" className="mt-8 w-full h-11 rounded-full text-white bg-blue-700 hover:opacity-90 transition-opacity cursor-pointer">
                Login
            </button>
            <p className="text-gray-500/90 text-sm mt-6">Don’t have an account? <Link to={'/signin'} className="text-indigo-400 hover:underline hover:text-indigo-500" >Sign Up</Link></p>
        </form>
    </div>
</div>
      </section>
